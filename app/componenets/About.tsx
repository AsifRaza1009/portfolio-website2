...
{/* <div id="about" className='w-full md:h-screen p-2 flex items-center py-16'>
    ...
    <h2 className='text-2xl uppercase font-serif pl-4   text-blue-700 border-l-4  border-l-red-600 '>About Me</h2>
    <h3 className='py-4 text-red-500 text-xl font-serif'> Who I Am</h3>
    <p className='py-2 text-gray-700 font-serif'>
        I specialize in building mobile responsive front-end UI applications
             that connect with API’s and other backend technologies. I’m
             passionate about learning new technologies and understand there is
           ...
           <p className='py-2 text-gray-600 font-serif'>
             I started my professional carrier with banking in 2004 and till work in banking sector till 2017. Then after I start my own bussiness till 2022. I started web developement in 2022 managing multiple e-commerce
             websites on CMS platforms such as WordPress, BigCommerce, and
             Shopify. I have experience working directly with clients and taking
             mock wireframes all the way to deployed applications. In my spare
             time I run Code Commerce, a Youtube channel where I teach web
